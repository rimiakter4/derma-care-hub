...
// Vercel-এ ডাইনামিক ডাটা রেন্ডারিং নিশ্চিত করার জন্য
export const dynamic = "force-dynamic";

export default async function Allproducts() {
  let products = [];
  
  // ১. ডাইনামিক বেস ইউআরএল সেট করা
  ...
  // ৩. যদি কোনো ডাটা না পাওয়া যায় তার হ্যান্ডলিং
  if (!products || products.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center py-24">
          <h2 className="text-2xl font-bold text-red-500 mb-4">Products currently unavailable</h2>
          ...
          {products.map((item) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <Link 
                  href={`/products/${item.id}`} 
                  className="mt-auto w-full bg-secondary text-white py-3 rounded-md text-center text-sm font-bold hover:opacity-90 transition-all active:scale-[0.98]"
                >
                  See Details
                </Link>
              </div>
